...
import com.fasten.wp4.orion.client.model.AttributeValue;
...
public class AttributeValueApi {
    ...
    public com.squareup.okhttp.Call getAttributeValueCall(String entityId, String attrName, String type, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/entities/{entityId}/attrs/{attrName}/value"
     ...
     */
    public AttributeValue getAttributeValue(String entityId, String attrName, String type) throws ApiException {
        ApiResponse<AttributeValue> resp = getAttributeValueWithHttpInfo(entityId, attrName, type);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AttributeValue> getAttributeValueWithHttpInfo(String entityId, String attrName, String type) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call getAttributeValueAsync(String entityId, String attrName, String type, final ApiCallback<AttributeValue> callback) throws ApiException {
     ...
     * @param body JSON AttributeValue Representation (required)
     * @param type Entity type, to avoid ambiguity in the case there are several entities with the same entity id. (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateAttributeValueCall(String entityId, String attrName, AttributeValue body, String type, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateAttributeValueValidateBeforeCall(String entityId, String attrName, AttributeValue body, String type, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateAttributeValueCall(entityId, attrName, body, type, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void updateAttributeValue(String entityId, String attrName, AttributeValue body, String type) throws ApiException {
        updateAttributeValueWithHttpInfo(entityId, attrName, body, type);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> updateAttributeValueWithHttpInfo(String entityId, String attrName, AttributeValue body, String type) throws ApiException {
        com.squareup.okhttp.Call call = updateAttributeValueValidateBeforeCall(entityId, attrName, body, type, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateAttributeValueAsync(String entityId, String attrName, AttributeValue body, String type, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateAttributeValueValidateBeforeCall(entityId, attrName, body, type, progressListener, progressRequestListener);
