...
public class AttributesApi {
    ...
    public com.squareup.okhttp.Call getAttributeDataCall(String entityId, String attrName, String type, String metadata, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/entities/{entityId}/attrs/{attrName}"
     ...
     */
    public Entity getAttributeData(String entityId, String attrName, String type, String metadata) throws ApiException {
        ApiResponse<Entity> resp = getAttributeDataWithHttpInfo(entityId, attrName, type, metadata);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Entity> getAttributeDataWithHttpInfo(String entityId, String attrName, String type, String metadata) throws ApiException {
     ...
     */
    public com.squareup.okhttp.Call getAttributeDataAsync(String entityId, String attrName, String type, String metadata, final ApiCallback<Entity> callback) throws ApiException {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateAttributeDataCall(String entityId, String attrName, Object body, String type, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateAttributeDataValidateBeforeCall(String entityId, String attrName, Object body, String type, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void updateAttributeData(String entityId, String attrName, Object body, String type) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> updateAttributeDataWithHttpInfo(String entityId, String attrName, Object body, String type) throws ApiException {
        com.squareup.okhttp.Call call = updateAttributeDataValidateBeforeCall(entityId, attrName, body, type, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateAttributeDataAsync(String entityId, String attrName, Object body, String type, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateAttributeDataValidateBeforeCall(entityId, attrName, body, type, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
