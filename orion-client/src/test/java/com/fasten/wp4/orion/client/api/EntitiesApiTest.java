...
public class EntitiesApiTest {
    ...
    public void listEntitiesTest() throws ApiException {
        ...
        String orderBy = null;
        String options = "keyValues";
        List<Entity> response = api.listEntities(id, type, idPattern, typePattern, q, mq, georel, geometry, coords, limit, offset, attrs, metadata, orderBy, options);
    ...
    public void replaceAllEntityAttributesTest() throws ApiException {
        ...
        String type = null;
        String options = null;
        api.replaceAllEntityAttributes(entityId, body, type, options);
    ...
    public void retrieveEntityTest() throws ApiException {
        ...
        String metadata = null;
        String options = null;
        Entity response = api.retrieveEntity(entityId, type, attrs, metadata, options);
    ...
    public void retrieveEntityAttributesTest() throws ApiException {
        ...
        String metadata = null;
        String options = null;
        Attribute response = api.retrieveEntityAttributes(entityId, type, attrs, metadata, options);
    ...
    public void updateExistingEntityAttributesTest() throws ApiException {
        ...
        String type = null;
        String options = null;
        api.updateExistingEntityAttributes(entityId, body, type, options);
