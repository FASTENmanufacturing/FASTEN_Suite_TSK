...
import com.fasten.wp4.bean.AsyncNotifyMB;
...
public class FrontendNotifyController {
    ...
    public Response getPars(@PathParam("eventName") String eventName) throws ApiException {
    	asyncNotifyMB.sendPushMessage(eventName);
