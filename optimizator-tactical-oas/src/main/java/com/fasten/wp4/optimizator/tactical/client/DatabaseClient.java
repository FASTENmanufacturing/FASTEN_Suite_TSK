...
//		TacticalOptimizationControllerApi tacticalOptimizationControllerApi = new TacticalOptimizationControllerApi();
...
//		TacticalOptimizationResultControllerApi tacticalOptimizationResultControllerApi = new TacticalOptimizationResultControllerApi();
//		tacticalOptimizationResultControllerApi.getApiClient().setLenientOnJson(true);
//		tacticalOptimizationResultControllerApi.getApiClient().setDebugging(true);
